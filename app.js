...
const SUPABASE_URL = window.FORGE_CONFIG?.supabaseUrl ?? "";
const SUPABASE_ANON_KEY = window.FORGE_CONFIG?.supabaseKey ?? "";
...
// ─── REACT BRIDGE ────────────────────────────────────────────────────────────
// Override all DOM-manipulation functions so business logic works with React.

function toast(msg) { window._forgeToast?.(msg); }

function renderAll() { window._forgeRefresh?.(); }
function renderLog() { window._forgeRefresh?.(); }
function renderSession() { window._forgeRefresh?.(); }
function renderLandingWorkouts() { window._forgeRefresh?.(); }
function renderHistory() { window._forgeRefresh?.(); }
function renderRoutines() { window._forgeRefresh?.(); }
function renderExercises() { window._forgeRefresh?.(); }
function renderStats() { window._forgeRefresh?.(); }
function renderTools() { window._forgeRefresh?.(); }
function updateCloudUI() { window._forgeRefresh?.(); }

function setView(v) { window._forgeSetView?.(v); }
function startTimer(s) { window._forgeStartTimer?.(s); }
function stopTimer() { window._forgeStopTimer?.(); }
...
function updateLatestUpdateStamp() {}
function openFinishSheet() {}
function closeFinishSheet() { window._forgeCloseFinish?.(); }
function updateFinishSheetActionLabel() {}
function openReplaceSheet() {}
function closeReplaceSheet() {}
function openWorkoutHistorySheet() {}
function openBodyMeasurementHistorySheet() {}
function openHistorySheet() {}
function closeHistorySheet() {}
function openHistoryActionSheet() {}
function closeHistoryActionSheet() {}
function openHistoryEditSheet() {}
function closeHistoryEditSheet() {}
...
function renderAdaptiveExercisePerformance() {}
function renderAdaptiveMeasurementPerformance() {}
function renderAdaptiveMuscleVolumeChart() {}
function renderExercisePerformanceStageA() {}
function renderExercisePerformanceStageB() {}
function renderExercisePerformanceStageC() {}
function renderExercisePerformanceStageC() {}
...
function init() {
  initSupabase().catch(() => { window._forgeRefresh?.(); });
  registerServiceWorker();
}
